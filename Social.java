//
//  - Run: javac -cp neo4j-java-driver-1.0.0.jar code.java
//  - Run: java -cp neo4j-java-driver-1.0.0.jar:. code
//
...
public class Social {
	...
	Driver driver = GraphDatabase.driver("bolt://localhost:7627",AuthTokens.basic("neo4j","password"),noSSL); // <password>
